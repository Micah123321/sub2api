export default {
    ...
    riskControl: {
      ...
      configHint: 'Choose Official Moderation or Chat Completions and handle audit hits by mode.',
      ...
      auditEngineModeration: 'Official Moderation',
      auditEngineModerationHint: 'Use /v1/moderations with the existing category scores and thresholds.',
      auditEngineChatCompletions: 'Chat Completions',
      auditEngineChatCompletionsHint: 'Use /v1/chat/completions with a custom model and audit prompt.',
      auditPrompt: 'Audit System Prompt',
      auditPromptHint: 'The model must treat user_input as data and return only the agreed JSON.',
      restoreAuditPrompt: 'Restore Default Prompt',
      ...
      auditTestConfidence: 'Custom model confidence {score}',
      auditTestConfidenceLabel: 'Confidence',
