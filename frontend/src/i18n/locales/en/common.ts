export default {
  ...
  adminCompliance: {
    ...
    documentSource: 'The agreement text comes from built-in Markdown files in this project. When the agreement content changes, the document version must be incremented; acknowledgments of older versions become invalid and console users must acknowledge again.',
