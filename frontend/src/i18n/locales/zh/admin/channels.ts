export default {
    ...
    riskControl: {
      ...
      refresh: '刷新',
      config: '内容审计配置',
      configHint: '选择官方 Moderation 或普通 Chat Completions 审计引擎，命中后按模式处理。',
      openSettings: '内容审计设置',
      ...
      auditEngine: '审计引擎',
      auditEngineModeration: '官方 Moderation',
      auditEngineModerationHint: '调用 /v1/moderations，继续使用现有分类分数和阈值。',
      auditEngineChatCompletions: '普通 Chat Completions',
      auditEngineChatCompletionsHint: '调用 /v1/chat/completions，使用自定义模型和审计提示词。',
      auditPrompt: '审计系统提示词',
      auditPromptHint: '模型必须把 user_input 视为待审核数据，并只返回约定 JSON。',
      restoreAuditPrompt: '恢复默认提示词',
      ...
      auditTestConfidence: '自定义模型置信度 {score}',
      auditTestConfidenceLabel: '置信度',
      auditTestReason: '理由：{reason}',
