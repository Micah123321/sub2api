...
// ContentModerationDefaultAuditPrompt returns the built-in audit system prompt.
func ContentModerationDefaultAuditPrompt() string {
	return defaultContentModerationAuditPrompt
}
